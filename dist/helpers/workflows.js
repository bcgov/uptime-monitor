...
const introComment = async () => `# This file was generated by bcgov/uptime-monitor@${await exports.getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: bcgov/uptime-monitor@${await exports.getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
    ...
    steps:
      - name: Checkout
        ...
        with:
          ...
          token: \${{ secrets.GH_PAT }}
      - name: Update template
        uses: bcgov/uptime-monitor@master
        with:
          command: "update-template"
        env:
          GH_PAT: \${{ secrets.GH_PAT }}
