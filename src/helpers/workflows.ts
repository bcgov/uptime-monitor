...
const introComment = async () => `# This file was generated by bcgov/uptime-monitor@${await getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: bcgov/uptime-monitor@${await getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
